...
import {PostListPageComponent} from "./pages/post/post-list-page/post-list-page.component";
...
export const routes: Routes = [
  ...
  {path: ':userId/blog/:blogId/posts', component: PostListPageComponent, canActivate: [authGuard]},
